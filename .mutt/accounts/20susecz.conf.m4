...
folder-hook imaps://imap.suse.de/ 'set folder=imaps://imap.suse.de/ record=imaps://imap.suse.de/INBOX/Sent postponed=imaps://imap.suse.de/INBOX/Unsent from="Miklos Vajna <vmiklos@suse.cz>";unset crypt_autosign; set sort=threads'
